...
(function($){
	...
	$.fn.contactable = function(options) {
		...
		return this.each(function() {
			...
			$(this).html('<div id="contactable_inner" class="view over"></div><div id="box" style="z-index:1000;position:absolute;height:400px;width:295px;background-color:#ddd;margin-left:-300px;top:80px;border:1px solid #000;"><div id="menu" style="padding:15px;"><span id="welcome"></span><button name="logout" id="logout">Logout</button><div id="switcher"></div><div class="menu-icons"><a href="javascript:void(0);" name="genPdf" id="genPdf"><img title="Export to PDF" id="pdf" src="img/pdf.jpg" /></a></div></div><div id="main"><div id="icon"><a href="index.php?vertical=na" name="navXTable" id="navXTable" title="xTable"><img alt="XTable" id="XTable" src="img/xtable.png" height=" " width=" " /></a></div><div id="icon"><a href="dashboard.html" name="navDashboard" id="navDashboard" ><img alt="Dashboard" id="Dashboard" src="img/dashboard.png" height=" " width=" " title="Dashboard"/></a></div><div id="icon"><a target="_blank"  href="reportgen.php" name="navReporting" id="navReporting" title="Reporting"><img alt="Reporting" id="Reporting" src="img/reports_icon.jpg" height=" " width=" " /></a></div><div id="icon"><a href="admin.php" name="navAdministration" id="navAdministration"><img alt="Administration" id="Administration" src="img/admin.png" height=" " width=" " title="Administration"/></a></div></div></div>');
			//show / hide function
